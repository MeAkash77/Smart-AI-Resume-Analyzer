...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/MeAkash77/Smart-AI-Resume-Analyzer' target='_blank' style='text-decoration: none;'>
    ...
    def render_dashboard(self):
        ...
        st.toast("Check out these repositories: [Awesome Hacking](https://github.com/MeAkash77)", icon="ℹ️")
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories: [30-Days-Of-Rust](https://github.com/MeAkash77)", icon="ℹ️")
    ...
    "assets",
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <div class="social-links">
                    ...
                    <a href="https://www.linkedin.com/in/me-akash77/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:iakshu845@gmail.com" class="social-link" target="_blank">
        ...
        st.toast("Check out these repositories: [Iriswise](https://www.linkedin.com/in/me-akash77/)", icon="ℹ️")
    ...
    "Upload your resume", type=[
        ...
        st.toast("Check out these repositories: [Awesome Java](https://www.linkedin.com/in/me-akash77/)", icon="ℹ️")
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/MeAkash77)", icon="ℹ️")
    ...
    def render_job_search(self):
        ...
        st.toast("Check out these repositories: [GeeksforGeeks-POTD](https://github.com/MeAkash77)", icon="ℹ️")
    ...
    def render_feedback_page(self):
        ...
        st.toast("Check out these repositories: [TryHackMe Free Rooms](https://github.com/MeAkash77)", icon="ℹ️")
...
<div style="background-color: #1e1e1e; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
    ...
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/MeAkash77" target="_blank" style="color: #4CAF50;">Github</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Programming Languages:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://www.linkedin.com/in/me-akash77/" target="_blank" style="color: #4CAF50;">Linkedin</a></li>
        <li><a href="https://akash77port.netlify.app/" target="_blank" style="color: #4CAF50;">Portfolio</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>Data Structures & Algorithms:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://dev-verse-swe-blog-three.vercel.app/" target="_blank" style="color: #4CAF50;">My Blogs</a></li>
    </ul>
    <div style="margin-bottom: 5px;"><b>AI/ML Projects:</b></div>
    <ul style="margin-top: 0; padding-left: 20px;">
        <li><a href="https://github.com/MeAkash77" target="_blank" style="color: #4CAF50;">My Self</a></li>
    </ul>
